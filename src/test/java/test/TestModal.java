...
import lyfjshs.gomis.test.simple.SimpleMessageModal;
...
public class TestModal extends BaseFrame {
	...
	private void showCustomModal(Component com, SimpleMessageModal.Type type) {
		...
		ModalDialog.showModal(com, new SimpleMessageModal(type, message, "This is a modal custom message",
	...
	private void installDefaultOption() {
		...
		modalOption.setHeavyWeight(true)
				  .getBorderOption()
		...
		toastOption.setHeavyWeight(true)
