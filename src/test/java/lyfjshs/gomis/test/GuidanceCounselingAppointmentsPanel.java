...
public class GuidanceCounselingAppointmentsPanel extends JPanel {
    ...
    public GuidanceCounselingAppointmentsPanel() {
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new GuidanceCounselingAppointmentsPanel());
