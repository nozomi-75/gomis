...
public class SignUpPanel extends JPanel {
    ...
    public SignUpPanel() {
        ...
        add(titleLabel, "cell 0 0,growy,gapy 10");
        ...
        add(txtUsername, "cell 0 9");
        add(new JLabel("Password"), "cell 0 10,gapy 8");
        add(txtPassword, "cell 0 11");
        add(passwordStrengthLabel, "cell 0 12,gapy 5");
        add(new JLabel("Confirm Password"), "cell 0 13,gapy 5");
        add(txtConfirmPassword, "cell 0 14");
        add(btnSignUp, "cell 0 15,gapy 20");
