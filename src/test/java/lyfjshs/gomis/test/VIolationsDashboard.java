...
public class VIolationsDashboard extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new VIolationsDashboard().setVisible(true);
        });
    }

    public VIolationsDashboard() {
    ...
    private void addViolationRecord(String name, String lrn, String gradeSection, int age, String sex,
                                    ...
                                    String reinforcement, String sessionSummary, String[] sessions, String[] incidents) {
        ...
        detailsPanel.add(new JLabel("<html><b>Session Summary</b></html>"), "growx");
        detailsPanel.add(new JLabel(sessionSummary), "growx");
