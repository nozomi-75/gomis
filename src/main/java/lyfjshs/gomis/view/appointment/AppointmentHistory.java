...
public class AppointmentHistory extends JPanel {
    ...
    private JButton endedButton, cancelledButton, allButton;
    ...
    public AppointmentHistory(AppointmentDAO appointmentDAO, Connection connection) {
        ...
        endedButton = createFilterButton("Ended");
        cancelledButton = createFilterButton("Cancelled");
        allButton = createFilterButton("All History");
        allButton.putClientProperty("FlatLaf.styleClass", "accent");
        
        filterButtonsPanel.add(endedButton);
    ...
    private JButton createFilterButton(String label) {
        ...
        filterButton.addActionListener(e -> {
            ...
            if ("All History".equalsIgnoreCase(label)) {
                filterAppointments("all");
            } else {
                filterAppointments(label);
            }
        });
        return filterButton;
    }
    ...
    private void updateFilterButtonStyles() {
        endedButton.putClientProperty("FlatLaf.styleClass", "ended".equals(activeFilter) ? "accent" : "");
        cancelledButton.putClientProperty("FlatLaf.styleClass", "cancelled".equals(activeFilter) ? "accent" : "");
        allButton.putClientProperty("FlatLaf.styleClass", "all".equals(activeFilter) ? "accent" : "");
    }
