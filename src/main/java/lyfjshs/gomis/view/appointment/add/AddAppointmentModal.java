    ...
    public void showModal(Connection connection, Component parent, AddAppointmentPanel panel, 
        ...
        try {
            ...
            ModalDialog.showModal(parent,
                new SimpleModalBorder(panel, "Add Appointment",
                    new SimpleModalBorder.Option[] {
                        new SimpleModalBorder.Option("Save", SimpleModalBorder.YES_OPTION),
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(parent,
                "Error showing appointment dialog: " + e.getMessage(),
                "Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
