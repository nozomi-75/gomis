...
public class S_ReportTablePanel extends JPanel {
    private static final Logger logger = LogManager.getLogger(S_ReportTablePanel.class);
    private final JLabel summaryLabel;
    private final DefaultTableModel tableModel;
    private final JTable table;
    private final JButton exportButton;

    public S_ReportTablePanel() {
        super(new MigLayout("fillx, insets 15", "[grow,fill]", "[][::500px][][]"));
    ...
    public void updateTableData(java.util.List<Object[]> rows, String summaryText) {
        try {
            ...
            logger.error("Error updating table data", e);
            JOptionPane.showMessageDialog(this, "Error updating table data: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
