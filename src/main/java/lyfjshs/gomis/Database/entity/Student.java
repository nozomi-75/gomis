...
public class Student {
    ...
    public String getStudentMiddlename() { return studentMiddlename; }
    public void setStudentMiddlename(String studentMiddlename) { this.studentMiddlename = studentMiddlename; }

    public String getStudentSex() { return studentSex; }
    public void setStudentSex(String studentSex) { this.studentSex = studentSex; }

    public Date getStudentBirthdate() { return studentBirthdate; }
    public void setStudentBirthdate(Date studentBirthdate) { this.studentBirthdate = studentBirthdate; }

    public String getStudentMothertongue() { return studentMothertongue; }
    public void setStudentMothertongue(String studentMothertongue) { this.studentMothertongue = studentMothertongue; }

    public int getStudentAge() { return studentAge; }
    public void setStudentAge(int studentAge) { this.studentAge = studentAge; }

    public String getStudentIpType() { return studentIpType; }
    public void setStudentIpType(String studentIpType) { this.studentIpType = studentIpType; }

    public String getStudentReligion() { return studentReligion; }
    public void setStudentReligion(String studentReligion) { this.studentReligion = studentReligion; }
}
